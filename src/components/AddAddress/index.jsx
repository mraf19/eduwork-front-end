      ...
      <Row>
        ...
        <Col md={6}>
          <Form.Group className="mb-3" controlId="provinsi">
            ...
            <CustomFormSelect
              onChange={(value) => {
                updateValue("provinsi", JSON.parse(value));
              }}
          ...
          <Form.Group className="mb-3" controlId="kabupaten">
            ...
            <CustomFormSelect
              onChange={(value) => {
                updateValue("kabupaten", JSON.parse(value));
              }}
          ...
          <Form.Group className="mb-3" controlId="kecamatan">
            ...
            <CustomFormSelect
              onChange={(value) => {
                updateValue("kecamatan", JSON.parse(value));
              }}
          ...
          <Form.Group className="mb-3" controlId="kelurahan">
            ...
            <CustomFormSelect
              onChange={(value) => {
                updateValue("kelurahan", JSON.parse(value));
              }}
